...
const CocktailModal = ({ cocktail, onClose, labels }) => {
  ...
  return (
    ...
    >
      ...
      <div 
        className="relative w-full max-w-2xl bg-[#171717] border border-[#262626] rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
        onClick={e => e.stopPropagation()}
      >
        {/* Modal Header - Fixed at top */}
        <div className="flex-shrink-0 p-6 md:p-8 border-b border-[#262626] flex justify-between items-start bg-[#171717]">
          <div>
          ...
          <button 
            onClick={onClose}
            className="flex-shrink-0 p-2 rounded-full hover:bg-[#262626] text-neutral-500 hover:text-white transition-all -mr-2 -mt-2"
          >
